...
| [@bytemd/plugin-file-upload](https://github.com/bytedance/bytemd/tree/main/packages/plugin-file-upload) | [![npm](https://img.shields.io/npm/v/@bytemd/file-upload.svg?label=)](https://npm.im/@bytemd/plugin-file-upload) | Support Zip upload |
